...
class PreferencesStore(
    ...
    val exactNutritionLookupEnabled: Flow<Boolean> = ds.data.map { it[Keys.EXACT_NUTRITION_LOOKUP_ENABLED] ?: true }
    suspend fun setExactNutritionLookupEnabled(v: Boolean) { ds.edit { it[Keys.EXACT_NUTRITION_LOOKUP_ENABLED] = v } }

    val openFoodFactsTextLookupEnabled: Flow<Boolean> = ds.data.map { it[Keys.OPEN_FOOD_FACTS_TEXT_LOOKUP_ENABLED] ?: true }
    suspend fun setOpenFoodFactsTextLookupEnabled(v: Boolean) { ds.edit { it[Keys.OPEN_FOOD_FACTS_TEXT_LOOKUP_ENABLED] = v } }
    ...
    private object Keys {
        ...
        val EXACT_NUTRITION_LOOKUP_ENABLED = booleanPreferencesKey("exactNutritionLookupEnabled")
        val OPEN_FOOD_FACTS_TEXT_LOOKUP_ENABLED = booleanPreferencesKey("openFoodFactsTextLookupEnabled")
