    ...
    return buildString {
        append(
            """
                ...
                structured_items is required. It is used only for database matching. Return each distinct food once using {"name":"...","brand":null,"quantity":0.0,"unit":"g","branded":false,"variant":null,"preparation":null,"modifiers":[],"portion_estimated":false}. Preserve stated brands, product variants, preparation words like raw/cooked, and user-visible quantities/units. Use null for unknown brand/quantity/unit/variant/preparation.
