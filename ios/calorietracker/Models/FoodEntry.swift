...
struct MealIngredient: Identifiable, Codable, Equatable, Sendable {
    ...
    var nutritionSourceMetadata: NutritionSourceMetadata?
...
struct FoodEntry: Identifiable, Codable {
    ...
    private enum CodingKeys: String, CodingKey {
        ...
        case nutritionDataSource, nutritionSourceMetadata
    }
    ...
    init(from decoder: Decoder) throws {
        ...
        nutritionDataSource = try container.decodeIfPresent(NutritionDataSource.self, forKey: .nutritionDataSource)
            ?? NutritionDataSource.defaultValue(for: source)
        nutritionSourceMetadata = try container.decodeIfPresent(NutritionSourceMetadata.self, forKey: .nutritionSourceMetadata)
    }
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try container.encode(nutritionDataSource, forKey: .nutritionDataSource)
        try container.encodeIfPresent(nutritionSourceMetadata, forKey: .nutritionSourceMetadata)
    }
...
extension NutritionDataSource {
    nonisolated static func defaultValue(for source: FoodSource) -> NutritionDataSource {
        switch source {
        case .barcode:
            return .openFoodFacts
        case .manual, .nutritionLabel:
            return .manual
        case .snapFood, .textInput:
            return .aiEstimate
        }
    }
}
