...
struct EditFoodEntryView: View {
    ...
    @State private var nutritionDataSource: NutritionDataSource
    @State private var nutritionSourceMetadata: NutritionSourceMetadata?
    ...
    init(entry: FoodEntry) {
        ...
        self._nutritionDataSource = State(initialValue: entry.nutritionDataSource)
        self._nutritionSourceMetadata = State(initialValue: entry.nutritionSourceMetadata)
    ...
    private func reprocess() {
        Task {
            ...
            do {
                ...
                nutritionDataSource = newAnalysis.nutritionDataSource
                nutritionSourceMetadata = newAnalysis.nutritionSourceMetadata
